...
export default {
  ...
  methods: {
    async UserLogin() {
      ...
      try {
        const response = await axios.post('https://nemsu-grading.online/api/auth/local?populate[user_permission]=*', {
        ...
        let config = {
          ...
          url: 'https://nemsu-grading.online/api/users/me?populate=*',
          headers: { 
